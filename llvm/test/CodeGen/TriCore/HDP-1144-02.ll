...
entry:
  %ptrLst = alloca [7 x i8*], align 4
  %0 = bitcast [7 x i8*]* %ptrLst to i8*
  ...
  %2 = bitcast [7 x i8*]* %ptrLst to i16**
  store i16* %arraydecay, i16** %2, align 4, !tbaa !2
  %arrayinit.element = getelementptr inbounds [7 x i8*], [7 x i8*]* %ptrLst, i32 0, i32 1
  %3 = bitcast i8** %arrayinit.element to %struct.MyStruct_t**
  store %struct.MyStruct_t* %1, %struct.MyStruct_t** %3, align 4, !tbaa !2
  %arrayinit.element2 = getelementptr inbounds [7 x i8*], [7 x i8*]* %ptrLst, i32 0, i32 2
  ...
  %arrayidx = getelementptr inbounds [7 x i8*], [7 x i8*]* %ptrLst, i32 0, i32 %cond
