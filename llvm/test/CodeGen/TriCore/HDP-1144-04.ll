...
entry:
  ...
  %11 = bitcast i8** %arrayinit.element21 to i16**
  store i16* %arraydecay1, i16** %11, align 4, !tbaa !2
  %conv = zext i8 %arg1 to i32
  %add.ptr = getelementptr inbounds %struct.MyStruct_t, %struct.MyStruct_t* %.cast, i32 0, i32 3, i32 %conv
  %12 = load i16, i16* %add.ptr, align 2, !tbaa !6
  %13 = and i16 %12, 255
  %cmp = icmp ult i16 %13, 11
  %narrow = select i1 %cmp, i16 %13, i16 0
  ...
  %15 = load i16*, i16** %14, align 4, !tbaa !2
  call void @llvm.lifetime.end.p0i8(i64 40, i8* nonnull %0) #3
  %call = tail call signext i16 @ExternFunction(i16 signext %arg2, i16 signext %arg0, i16* %15) #3
  ret i16 %call
}
